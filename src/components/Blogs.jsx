  ...
  const blogs = [
    {
      ...
      title: 'The Importance of Effective Spend Management for Businesses',
    ...
    },
    {
      ...
      title: 'Unlocking Business Growth with SaaS Management ',
    ...
    <div className="bg-[#FAFAFA] py-10 md:py-20" id="blog-section-id">
      <div className="container">
        ...
        <motion.div
          ...
          whileInView="show"
          viewport={{ once: true }} 
          className="m-auto  w-full md:w-1/2 text-center mb-8 md:mb-20">
            ...
            {blogs.map((blog, i) => (
              ...
              >
                <img
                  ...
                  alt={blog.title}
                />
                <h2 className="text-xl font-medium pb-6">{blog.title}</h2>
                <p className="  text-[#999999]">
                  {blog.des}
                  <Link to={blog.url} className="text-blue-500 font-medium">
                    Read More
                  </Link>
                </p>
              </div>
        ...
        <div className="text-center">
          <Link
            to="https://easexpenses.wordpress.com/"
            className="text-main inline-block  text-lg font-medium hover:bg-main hover:text-light border border-main rounded-xl py-4 px-10 transition-all duration-300"
          >
            Explore more
          </Link>
        </div>
